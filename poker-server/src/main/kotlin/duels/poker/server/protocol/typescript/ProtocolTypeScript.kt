...
/**
 * Assembles the complete TypeScript protocol file as a string: a header naming the regeneration
 * command, the protocol version as a type alias, and every declaration from [protocolDeclarations].
 *
 * @return The complete TypeScript file with Unix line endings, ending with exactly one `\n`.
 */
internal fun protocolTypeScript(): String {
    val header = """// Generated by ./gradlew :poker-server:generateProtocolTypes -- do not edit by hand.
// Regenerate after any change to the Kotlin protocol; never hand-merge this file."""

    val versionAlias = "export type ProtocolVersion = $PROTOCOL_VERSION;"

    val declarations = protocolDeclarations().joinToString("\n\n") { it.text }
