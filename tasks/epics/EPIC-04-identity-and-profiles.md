...
**Two, both the architect's, and none the human's.** One was raised on 2026-08-16 while the stories
were written and blocks one story; the other came out of splitting `STORY-0403` on 2026-08-17 and
blocks nothing at all. `DEC-045`, raised on 2026-08-17 by `ADR-0049`, was answered the same day by
[`ADR-0050`](../../docs/adr/ADR-0050-revoking-the-device-signs-out-everywhere-but-here.md) and has
moved to the table below. No story below waits on a human.
...
The eleven answered ones are kept here with their answers because the story table still cites them,
