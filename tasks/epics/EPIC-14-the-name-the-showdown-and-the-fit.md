...
and stands under *Answered* below. That ADR registers **`DEC-157`**, the product owner's — whether
...
this epic, and was until 2026-09-09 the only row this epic had left open — `DEC-158`, below, was
the second for one day, and [`ADR-0148`](../../docs/adr/ADR-0148-a-module-names-every-card-that-draws-it-and-every-card-is-registered.md) answers it on 2026-09-10, so `DEC-157`
is once again the only one. The other row that remains in
