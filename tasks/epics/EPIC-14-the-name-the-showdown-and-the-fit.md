...
| `STORY-1412` | No card on the table is marked, and a gate says so — *item 2b, answered **no** by [`ADR-0126`](../../docs/adr/ADR-0126-the-table-shows-the-cards-and-marks-none-of-them.md): no wire move, no `atomic:` ticket* | nothing |
