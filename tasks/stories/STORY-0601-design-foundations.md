...
| [TASK-060111](../tasks/TASK-060111-drift-check-compares-values.md) | The drift check compares values, not only names | done |
| [TASK-060112](../tasks/TASK-060112-drift-gate-reads-the-graphics.md) | The drift gate reads the graphics | done |
| [TASK-060113](../tasks/TASK-060113-inlined-symbols-match-their-canonicals.md) | The gallery's inlined symbols match their canonicals | done |
...
| [TASK-060121](../tasks/TASK-060121-semicolonless-declaration-enters-the-gate.md) | The value gate reads CSS values correctly | done |
| [TASK-060122](../tasks/TASK-060122-the-design-gate-runs-in-ci.md) | The design gate runs in CI | done |
