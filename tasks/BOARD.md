...
nothing startable, because **eleven product decisions** stand in front of it — nine of them,
`DEC-129`, `DEC-130` and `DEC-133`–`DEC-139`, now answered.
...
not released; `DEC-132` would hand a browser a new profile
against `ADR-0012`'s device binding; `DEC-133` asked to widen what a showdown shows against `ADR-0008`'s
...
| `STORY-1410` | Signing out hands the browser a new anonymous profile — *item 1d* | `DEC-132` |
