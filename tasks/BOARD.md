...
`ADR-0114`, so `STORY-1308`, `STORY-1309` and `STORY-1311` are no longer blocked; `DEC-124` alone
still gates the implementing tickets of `STORY-1303` and `STORY-1306`. The order is one chain and it is not
