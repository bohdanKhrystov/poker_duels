...
learning a deadline. **§6**: registers `DEC-166`.
...
durations where it carried one, a permanent tax on four lines of `isReapable`. Registers `DEC-166` —
