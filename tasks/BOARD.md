...
| [STORY-0503](stories/STORY-0503-the-ladder-is-a-screen.md) The ladder is a screen, reached from the first screen and left by one control | | | **in progress** — 13 of 15 tickets |
...
| | [TASK-050314](tasks/TASK-050314-the-screen-a-player-can-reach-one-control-in-one-control-back.md) The ladder is a screen a player can reach — one control in, one control back | S | ready |
