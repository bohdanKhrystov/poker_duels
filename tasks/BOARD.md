...
| `STORY-1413` | The pot travels to the winner — *item 2c* | nothing — `STORY-1412` no longer holds the version lock |
...
**`STORY-1401`–`STORY-1405`, `STORY-1411`, `STORY-1414` and `STORY-1416` are written and split; the
other seven seams are not.**
