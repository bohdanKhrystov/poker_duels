...
| [STORY-0506](stories/STORY-0506-a-duel-moves-a-rank.md) A duel moves a rank, end to end | | | **in progress** — 6 of 9 tickets |
...
| | [TASK-050607](tasks/TASK-050607-a-player-whose-only-duel-was-a-loss-has-a-row-and-it-reads-minus-one.md) A player whose only duel was a loss has a row, and it reads minus one | S | ready |
