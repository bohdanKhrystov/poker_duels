...
decisions. **`STORY-1301`, `STORY-1302` and `STORY-1303` are cut into tickets** — three, seven and
four; the other eight are not, because `/plan-story <STORY-ID>` does that one story at a time, and
