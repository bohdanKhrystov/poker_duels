...
| `STORY-1407` | A player names themselves before their first duel — *item 1a; [`ADR-0119`](../docs/adr/ADR-0119-the-name-is-asked-at-the-first-press-and-skipping-plays.md) is the answer* | ~~`DEC-142`~~ — **answered 2026-09-07** by [`ADR-0137`](../docs/adr/ADR-0137-a-name-suggestion-is-drawn-in-the-browser.md); **nothing blocks it**, and its tickets are **not** `atomic:` |
...
**`STORY-1401`–`STORY-1405`, `STORY-1411`, `STORY-1413`, `STORY-1414` and `STORY-1416` are written
and split; the other six seams are not.**
