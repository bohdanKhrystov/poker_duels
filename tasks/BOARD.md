...
| [STORY-0503](stories/STORY-0503-the-ladder-is-a-screen.md) The ladder is a screen, reached from the first screen and left by one control | | | **in progress** — 4 of 15 tickets |
...
| | [TASK-050305](tasks/TASK-050305-the-walk-appends-and-a-failed-request-un-reads-nothing.md) The ladder walk is a reducer that appends, and a failed request un-reads nothing | S | ready |
