...
| `STORY-1405` | The table fits the phone it is played on — *item 3d* | nothing — `DEC-136` → `ADR-0121` |
...
**`STORY-1401`–`STORY-1404`, `STORY-1411`, `STORY-1414` and `STORY-1416` are written and split; the
other eight seams are not.** The planner writes each one once the decisions it waits on are merged, and the
