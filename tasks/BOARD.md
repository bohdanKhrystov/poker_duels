...
| | [TASK-121103](tasks/TASK-121103-the-duels-rows-and-filter-carry-the-cards-remaining-cues.md) The `duels` screen's checked filter, faint date and outcome weight are the card's — *product; `medium`* | S | backlog |
