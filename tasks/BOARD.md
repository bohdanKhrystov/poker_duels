...
| | [TASK-121005](tasks/TASK-121005-the-sign-in-submit-is-the-cards-fill-button.md) The `sign-in` form's submit is the card's fill button, not a smaller one — *product; `medium`; one half of the ticket round 2 filed, **split 2026-08-31*** | XS | ready |
...
| | [TASK-121101](tasks/TASK-121101-the-table-says-who-won-the-hand-it-just-finished.md) The table says who won the hand it just finished — *product; `medium`, rewritten from [ADR-0095](../docs/adr/ADR-0095-the-table-states-who-took-the-pot-and-never-names-a-hand.md); the banner and its six gated strings* | S | ready |
