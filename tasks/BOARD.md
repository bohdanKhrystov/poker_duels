...
| **[STORY-1309](stories/STORY-1309-the-table-counts-down-and-the-pause-leaves-the-screen.md)** The table counts down, and the pause leaves the screen — *item 4c* | | | **backlog** — `DEC-120` was answered by [`ADR-0113`](../docs/adr/ADR-0113-the-turn-clock-is-derived-state-and-the-sweep-plays-the-seat.md) on 2026-09-02 and this story is no longer blocked; it needs `/plan-story` |
