...
| [STORY-0503](stories/STORY-0503-the-ladder-is-a-screen.md) The ladder is a screen, reached from the first screen and left by one control | | | **in progress** — 3 of 15 tickets |
...
| | [TASK-050304](tasks/TASK-050304-the-read-the-device-id-is-optional-and-there-is-no-401.md) The ladder read — the device id is optional here, and there is no 401 to fear | S | ready |
