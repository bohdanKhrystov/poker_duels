...
| `STORY-1412` | No card on the table is marked, and a gate says so — *item 2b, answered `no` by [`ADR-0126`](../docs/adr/ADR-0126-the-table-shows-the-cards-and-marks-none-of-them.md): no wire move, one gate and one line on the showdown card* | nothing |
...
**`STORY-1401`–`STORY-1405`, `STORY-1407`, `STORY-1411`, `STORY-1413`, `STORY-1414` and
`STORY-1416` are written and split; the other five seams are not.**
