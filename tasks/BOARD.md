...
| [STORY-0502](stories/STORY-0502-the-standings-read-path.md) The standings read path — ordered, paged, and a rank the server computes | | | **in progress** — 13 of 19 tickets |
...
| | [TASK-050214](tasks/TASK-050214-a-duel-that-commits-mid-walk-is-in-no-page-of-it.md) A duel stamped at the cutoff is in no page of the walk, and the ranks stay the cutoff's | S | ready |
