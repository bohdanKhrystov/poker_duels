...
| [STORY-0503](stories/STORY-0503-the-ladder-is-a-screen.md) The ladder is a screen, reached from the first screen and left by one control | | | **in progress** — 8 of 15 tickets |
...
| | [TASK-050309](tasks/TASK-050309-the-screen-names-the-season-the-response-carried.md) The screen names the season the response carried, and its four states are four sentences | S | ready |
