...
| | [TASK-041708](tasks/TASK-041708-one-request-one-answer-and-nothing-to-read-into-it.md) One request, one answer, and nothing to read into it | XS | backlog — **written while its screen was held**: two outcomes and no third, with the three failing statuses asserted identical. `ADR-0087` answered `DEC-081` and moved no line of it |
