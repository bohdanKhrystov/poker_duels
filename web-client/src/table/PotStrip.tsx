...
import type { GameEvent, PlayerView, Street } from "../protocol";
...
export function PotStrip(props: {
  ...
  return (
    <div className="flex flex-wrap items-baseline justify-center gap-x-4 gap-y-1 px-2 py-3 text-center short:py-1">
