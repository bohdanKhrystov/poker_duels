 ...
 * two bindings has to live in the test file, never here — this is the
 ...
 * and `bootClient` below writes all two fields on every boot before
 * rendering.
 *
